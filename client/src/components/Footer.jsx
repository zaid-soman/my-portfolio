...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/in/zaid-soman/", label: "LinkedIn" },
    ...
    { icon: <Github size={18} />, href: "https://github.com/zaid-soman", label: "GitHub" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "codesoman@gmail.com", href: "mailto:codesoman@gmail.com" },
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">ZAID SOMAN</h3>
