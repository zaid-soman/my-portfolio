      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Computer Science student specializing in Artificial Intelligence and
            Machine Learning, passionate about creating intelligent systems that
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 md:gap-8 items-stretch">
          ...
          <motion.div className="lg:w-1/2 group" variants={itemVariants}>
